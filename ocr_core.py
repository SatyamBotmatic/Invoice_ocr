...
def ocr_core(filename,tempfile):
   ...
   #dynamic3 = re.findall(rf'((?<=' + dynamic_invoice_value_con3 + ').{4,17}\s)', text)
    ...
    try:
      ...
      return (ino, iname, idate, ibill, dynamic1, dynamic2, dynamic3,dynamic4,dynamic5);
    ...
    try:
      ...
      return (ino, iname, idate, ibill, dynamic1, dynamic2, dynamic3,dynamic4);
    ...
    try:
      ...
      return (ino, iname, idate, ibill, dynamic1, dynamic2, dynamic3);
    ...
    try:
        ...
        return (ino, iname, idate, ibill, dynamic1, dynamic2);
    ...
    try:
        ...
        return (ino, iname, idate, ibill, dynamic1);
